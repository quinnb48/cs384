...
let tokenize (s : string) : token list =
 ...
 let lex_tests =
    tokenize "type of let rec in if then else match with fun true false mod int bool string unit = + - * / < ^ && || not ~ ;; : -> => ( ) | , h1t_13 (* 1 + 2 *) \"hi\" "

let parse_lexbuf (b : Lexing.lexbuf) : Ast.prog =
    progp tok b
